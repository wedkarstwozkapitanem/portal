...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
    if (isset($_POST['miejscowosc']) && isset($_POST['praca']) && isset($_POST['hobby']) && isset($_POST['linki'])) {
        ...
        (string) $miejscowosc = mysqli_real_escape_string($baza, htmlentities($_POST['miejscowosc']));
        (string) $praca = mysqli_real_escape_string($baza, htmlentities($_POST['praca']));
        (string) $hobby = mysqli_real_escape_string($baza, htmlentities($_POST['hobby']));
        (string) $linki = mysqli_real_escape_string($baza, htmlentities($_POST['linki']));
