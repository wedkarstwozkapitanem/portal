...
<head>
    ...
    <title>ZALOGUJ SIĘ DO SERWISU SPOŁECZNOŚCIOWEGO WĘDKARSTWO Z KAPITANEM</title>
...
<body>
    <aside>
        <div class="pokaz">
            <img src="/zdjecia/pokaz.png" alt="Pokaz" />
        </div>
    </aside>
    <main>
        <div class="zaloguj">
            <div class="logowanie_panel wysrodkuj tytul">
                <h1>ZALOGUJ SIĘ DO KOKPITU </h1>
            </div>
